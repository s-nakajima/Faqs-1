 ...
 */
	public $migration = array(
		'up' => array(
			'create_table' => array(
				'faq_question_answer_orders' => array(
				...
				'faq_settings' => array(
					...
					'is_comment_auto_apploval' => array('type' => 'boolean', 'null' => false, 'default' => '1', 'comment' => 'Use of comments approval, 0:Unused 1:Use | コメントの承認機能 0:使わない 1:使う | | '),
			...
			'create_field' => array(
				'faqs' => array(
					'name' => array('type' => 'string', 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'FAQ name | FAQ名称 | | ', 'charset' => 'utf8', 'after' => 'block_id'),
					'is_auto_translated' => array('type' => 'boolean', 'null' => false, 'default' => '0', 'comment' => 'translation type. 0:original , 1:auto translation | 翻訳タイプ 0:オリジナル、1:自動翻訳 | | ', 'after' => 'name'),
					'translation_engine' => array('type' => 'string', 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'translation engine | 翻訳エンジン | | ', 'charset' => 'utf8', 'after' => 'is_auto_translated'),
				),
			),
			'drop_field' => array(
				'faqs' => array('category_id', 'status', 'question', 'answer'),
			),
			'alter_field' => array(
				'faqs' => array(
					'id' => array('type' => 'integer', 'null' => false, 'default' => null, 'key' => 'primary', 'comment' => 'ID | | | '),
		...
		'down' => array(
			'drop_table' => array(
				'faq_question_answer_orders', 'faq_question_answers', 'faq_settings'
			),
			'drop_field' => array(
				'faqs' => array('name', 'is_auto_translated', 'translation_engine'),
			),
			'create_field' => array(
				'faqs' => array(
