<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="row">
			...
			<?php echo $this->element('Faqs/content_edit_btn_category', array('published' => false, 'size' => '2 col-md-1')); ?>
		</div>
	</div>

	<div class="panel-body">
		<div class="row">
			<?php echo $this->element('Faqs/content_move_btn', array('size' => '2 col-md-2',
				'upDisabled' => false,
				'downDisabled' => true)); ?>
